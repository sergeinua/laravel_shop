                    ...
                    <div class="text-block" id="block-print">
                        ...
                        <div class="sel-params">
                            ...
                            <form action="/katalog" method="get">
                                ...
                                <div class="left-clmn">
                                    ...
                                    <div class="sel-par-item">
                                        <div class="line-f first">
                                            ...
                                            <span class="elems">
																					от <input name="filter[a][56][0]"
                                                                                              value="" class="text num"
                                                                                              type="text"> м

															&nbsp;&nbsp;до <input name="filter[a][56][1]" value=""
                                                                                  class="text num" type="text"> м
                                ...
                                <div class="left-clmn nb">
                                    ...
                                    <div class="sel-par-item">
                                        <div class="line-f first">
                                            ...
                                            <span class="elems">
						                                                                                                                                                                        <input name="filter[a][57][]"
                                                                                                                                                                                                       value="76"
                                                                                                                                                                                                       type="checkbox"> шерсть<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="78"
                                                                                                                                                   type="checkbox"> мериносовая шерсть<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="79"
                                                                                                                                                   type="checkbox"> хлопок<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="80"
                                                                                                                                                   type="checkbox"> акрил<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="81"
                                                                                                                                                   type="checkbox"> мохер<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="88"
                                                                                                                                                   type="checkbox"> альпака<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="87"
                                                                                                                                                   type="checkbox"> шелк<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="84"
                                                                                                                                                   type="checkbox"> вискоза<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="89"
                                                                                                                                                   type="checkbox"> лен<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="90"
                                                                                                                                                   type="checkbox"> бамбук<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="91"
                                                                                                                                                   type="checkbox"> козий пух<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="92"
                                                                                                                                                   type="checkbox"> кашемир<br>
                                                                                                                                            <input name="filter[a][57][]"
                                                                                                                                                   value="93"
                                                                                                                                                   type="checkbox"> микрополиэстер<br>
                                                            											</span>
                                            <div class="clear"></div>
                                        </div>
                                ...
                                <div class="submit">
                                    <input value="Подобрать" class="button" type="submit">
                                </div>
                                <table>
